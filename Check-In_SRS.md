...
Release 1.0 of Check In is a notification application for Android devices that allows users to respond rapidly to simple yes or no questions. After a question is sent, a notification arose on the receiver’s home screen prompting a response. A quick press of yes or no alerts the sender of their response.
